...
@section('content')
    ...
    <div id="breadcrumbsDiv">
        <div class="container breadcrumbs" typeof="BreadcrumbList" vocab="http://schema.org/">
            ...
            <span property="itemListElement" typeof="ListItem">
                <a property="item" typeof="WebPage" title="Go to the Charmington Iris category archives." href="{{ route('payment') }}"
            ...
            <span property="itemListElement" typeof="ListItem">
                <span property="name">Thanh toán dự án căn hộ Charmington Iris Quận 4</span>
                ...
                <div id="contentPost" class="col-md-8">
                    <main id="main" class="site-main" role="main">
                        ...
                        {{-- <div class="fYeuCau">
                            ...
                            <div class="fYeuCauF">
                                <div role="form" class="wpcf7" id="wpcf7-f146-p871-o1" lang="en-US" dir="ltr">
                                    <div class="screen-reader-response"></div>
                                    <form action="/charmington-iris/charmington-iris-phuong-thuc-thanh-toan/#wpcf7-f146-p871-o1" method="post" class="wpcf7-form"
                                    novalidate="novalidate">
                                        <div style="display: none;">
                                            <input type="hidden" name="_wpcf7" value="146" />
                                            <input type="hidden" name="_wpcf7_version" value="5.0.2" />
                                            <input type="hidden" name="_wpcf7_locale" value="en_US" />
                                            <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f146-p871-o1" />
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <span class="wpcf7-form-control-wrap link-bai">
                                                <input type="hidden" name="link-bai" value="http://thecharmingtoniris.com/charmington-iris/charmington-iris-phuong-thuc-thanh-toan/"
                                            ...
                                            <span class="wpcf7-form-control-wrap ngay-thang">
                                                <input type="hidden" name="ngay-thang" value="14-06-2018 01:31:06" size="40" class="wpcf7-form-control wpcf7dtx-dynamictext wpcf7-dynamichidden"
                                                aria-invalid="false" />
                                            </span>
